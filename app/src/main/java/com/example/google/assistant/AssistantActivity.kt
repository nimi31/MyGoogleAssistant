            ...
            speechRecognizer.setRecognitionListener(object : RecognitionListener {
                ...
                override fun onResults(bundles: Bundle?) {
                    ...
                    if (data != null) {
                        ...
                        when {
                            keeper.contains("thanks")||keeper.contains("Shukriya") -> speak("Its my job , let me know if there is something else", textToSpeech, assistantViewModel, keeper)
                            ...
                            keeper.contains("turn off bluetooth") || keeper.contains("turn off Bluetooth") -> turnOffBluetooth(this@AssistantActivity,textToSpeech,assistantViewModel,keeper)
                            ...
                            keeper.contains("jokes") -> joke(textToSpeech, assistantViewModel, keeper)
                            ...
                            keeper.contains("what is your name") || keeper.contains("your name")
                                ...
                                speak("I am Mili at  your service", textToSpeech, assistantViewModel, keeper)
